            ...
            <footer className="footer">
                <div className="footer-content">
                    <div className="footer-section">
                        ...
                        <p>
                            A modern, beautiful form interface for seamless n8n workflow integration.
                            Built with Next.js and designed for the best user experience.
                        </p>
                ...
                <div className="footer-bottom">
                    <p>&copy; {year || '2025'} n8n Form Integration. All rights reserved.</p>
                </div>
            </footer>
        </div>
    )
